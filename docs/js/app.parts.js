(function () {
	...
	window.parts = [
		...
		},
		{
			...
			levels: 3,
			title: 'プロチウム燃料セル',
			base_description: '%single_cell_description' + ' プロチウム燃料セルは完全に消費されると、消費したセル1個あたり以降発電量が10%増加する。',
			category: 'cell',
			experimental: true,
		...
		// Energy
		{
			...
			type: 'reflector',
			title: '中性子反射体',
			base_description: '%ticksパルス数の間、隣接した燃料セルの出力を%power_increase%増加させる。',
			levels: 5,
			category: 'reflector',
			level: 1,
			base_cost: 500,
		...
		},
		{
			...
			type: 'capacitor',
			title: 'コンデンサ',
			base_description: '原子炉の最大蓄電量を%reactor_power増加させる。最大%containmentの熱を保持します。',
			levels: 5,
			category: 'capacitor',
			level: 1,
			base_cost: 1000,
		...
		// Heat
		{
			...
			type: 'vent',
			title: '排気装置',
			base_description: '1ティックごとに自身の熱を%vent分下げる。最大%containmentの熱を保持します。',
			levels: 5,
			category: 'vent',
			level: 1,
			base_cost: 50,
		...
		},
		{
			...
			type: 'heat_inlet',
			title: '熱入口',
			base_description: '毎ティック、隣接するコンポーネントから%transferの熱を取り出して原子炉に移します。',
			levels: 5,
			category: 'heat_inlet',
			level: 1,
			base_cost: 160,
		...
		},
		{
			...
			type: 'heat_outlet',
			title: '熱出口',
			base_description: '%transferの熱を原子炉から取り出して隣接するコンポーネントに移します。',
			levels: 5,
		...
		},
		{
			...
			type: 'heat_outlet',
			title: 'エクストリーム熱出口',
			base_description: '原子炉から%transferの熱を取り出して隣接するコンポーネントに移します。範囲は%rangeマス分で、部品を中心にひし形の形状で広がります。',
			category: 'heat_outlet',
			experimental: true,
		...
		},
		{
			...
			title: '原子炉メッキ',
			base_description: '原子炉の最大熱量を%reactor_heat増加させる。',
			levels: 5,
		...
		},
		{
			...
			type: 'reactor_plating',
			title: '荷電原子炉メッキ',
			base_description: '原子炉の最大熱量と最大蓄電量を%reactor_heat増加させる。',
			category: 'reactor_plating',
			experimental: true,
		...
		},
		{
			...
			title: '粒子加速器',
			base_description: '加速器を通過する熱（最大%ep_heat）に基づいてEPを生成します。この部品が爆発すると即座に原子炉がメルトダウンします。最大%containmentの熱量を保持します。',
			levels: 5,
