...
(function () {
	...
	// Other vars
	var single_cell_description = '1ティックごとに%powerの電力と%heatの熱を生成します。%ticksティック持続。';
	var multi_cell_description = '%count個の%typeとして機能します。1ティックあたり、%powerの電力と%heatの熱を生成します。';
	...
	var part_settings;
	var part;
	var cell_prefixes = ['', '2連', '3連'];
	var prefixes = ['基本', '高度', '強化', '高性能', 'アルティメット'];
